...
export THEANO_FLAGS=mode=FAST_RUN,device=$device,floatX=float32,exception_verbosity=high #,blas.ldflags=-libsci
...
python $pdnndir/cmds/run_DNN.py --train-data "milliTrain.pickle.gz" \
                                ...
                                --lrate "C:.1:200" --momentum .5 --model-save-step 20 \
